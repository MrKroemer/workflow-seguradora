...
def _parse_policy_data_from_text(
    *,
    policy_id: str,
    insurer: str,
    text: str,
...
def parse_yelum_policy_data_from_text(policy_id: str, text: str) -> PortalPolicyData | None:
    return _parse_policy_data_from_text(
        policy_id=policy_id,
        insurer="Yelum",
        text=text,
...
class YelumPortalGateway(_BasePortalWebGateway):
    insurer_name = "Yelum"
...
class MapfrePortalGateway(_BasePortalWebGateway):
    insurer_name = "Mapfre"
